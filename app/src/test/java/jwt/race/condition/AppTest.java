...
public class AppTest {
    private static final JsonObject AUTH_OPTIONS = new JsonObject().put("keyStore", new JsonObject()
    ...
    public void initial() {
        vertx = Vertx.vertx();
        authProvider = new JWTAuthProviderImpl(vertx, new JWTAuthOptions(AUTH_OPTIONS));
    }
